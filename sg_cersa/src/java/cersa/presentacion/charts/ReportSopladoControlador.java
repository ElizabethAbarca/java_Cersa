 ...
 * @author ELIZABETH-PC
 */
@Named(value = "reportSoplado")
@SessionScoped
public class ReportSopladoControlador implements Serializable {
    ...
    /**
     * Creates a new instance of ReportSopladoControlador
     */
    public ReportSopladoControlador() {
    }

    public String getPathFileJasperSoplado() {
        return ("reportes/reportSoplado.jasper");
    }

    public String getNameFilePdf() {
        return "Reporte_Soplado_PDF_" + validacion.actualDate() + ".pdf";
    }

    public String getNameFileXLS() {
        return "Reporte_Soplado_XLS_" + validacion.actualDate() + ".xls";
    }
    ...
    public void generateReport() throws Exception {
        try {
            Map par = new HashMap();
            par.put("FIS", fechaInicio);
            par.put("FFS", fechaFin);
            par.put("MS", muestra);
            resultado = JasperReportUtil.getFromReportPrint(par, getPathFileJasperSoplado());
