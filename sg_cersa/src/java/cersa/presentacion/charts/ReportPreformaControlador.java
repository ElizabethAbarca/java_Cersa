 ...
 * @author ELIZABETH-PC
 */
@Named(value = "reportPreforma")
@SessionScoped
public class ReportPreformaControlador implements Serializable {
    ...
    /**
     * Creates a new instance of ReportPreformaControlador
     */
    public ReportPreformaControlador() {
    }

    public String getNameFilePdf() {
        return "Reporte_Preforma_PDF_" + validacion.actualDate() + ".pdf";
    }

    public String getNameFileXLS() {
        return "Reporte_Preforma_XLS_" + validacion.actualDate() + ".xls";
    }

    public String getPathFileJasper() {
        return ("reportes/reportPreforma.jasper");
    }
    ...
    public void generateReport() throws Exception {
        try {
            Map par = new HashMap();
            par.put("FIPF", fechaInicio);
            par.put("FFPF", fechaFin);
            par.put("SPF", subtipo);
